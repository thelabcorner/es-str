#!/usr/bin/env node
// ESSTR test harness: bundles tests/esstr-test-entry.ts to ESM, runs it in
// Node, and propagates failures as a nonzero exit. Node's native String
// trim/trimLeft/trimRight/trimStart/trimEnd are the differential oracles.
...
var ENTRY = join(ROOT, 'esstr-test-entry.ts');
var BUNDLE = join(ROOT, '.esstr-test.bundle.mjs');
